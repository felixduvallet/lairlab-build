...
# Get the path for installing python dist packages.
#  set(FOO "")
#  get_python_install_location(FOO)
#  message("foo: ${FOO}")
function(get_python_install_location PY_INSTALL_DIRECTORY)
  find_package(PythonInterp REQUIRED)
  # which python version?
  execute_process(COMMAND
    ${PYTHON_EXECUTABLE} -c "import sys; sys.stdout.write(sys.version[:3])"
